...
7. Click **openEuler-20.03-LTS-SP1-raspi-aarch64.img.xz** to download the openEuler Raspberry Pi image to the local PC.

8. Click **openEuler-20.03-LTS-SP1-raspi-aarch64.img.xz.sha256sum** to download the verification file of the openEuler Raspberry Pi image to the local PC.
...
Image file: **openEuler-20.03-LTS-SP1-raspi-aarch64.img.xz**

Verification file: **openEuler-20.03-LTS-SP1-raspi-aarch64.img.xz.sha256sum**
