...
4.  Run the  **dd**  command to write the ISO image to the USB flash drive.
    ...
    For example, if the ISO image file name is  **/home/testuser/Downloads/openEuler-21.03-aarch64-dvd.iso**  and the detected device name is  **sdb**, run the following command:
