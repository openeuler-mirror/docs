...
1. Получите установочный пакет isula-build-\*.rpm из источника openEuler yum, например isula-build-0.9.5-6.oe1.x86\_64.rpm.
...
### manifest: управление списком манифестов
...
#### inspect: запрос списка манифестов
