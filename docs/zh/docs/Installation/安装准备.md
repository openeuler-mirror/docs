...
3.  单击卡片 openEuler 20.03 LTS SP2 上的“获取ISO”，显示ISO下载列表。
...
4.  根据实际待安装环境的架构选择需要下载的 openEuler 的发布包和校验文件。
    -   若为AArch64架构。
        1.  单击“aarch64”。
        2.  若选择本地安装，分别将发布包 “openEuler-20.03-LTS-SP2-aarch64-dvd.iso”和校验文件“openEuler-20.03-LTS-SP2-aarch64-dvd.iso.sha256sum”下载到本地。
        3.  若选择网络安装，分别将发布包 “openEuler-20.03-LTS-SP2-netinst-aarch64-dvd.iso”和校验文件“openEuler-20.03-LTS-SP2-netinst-aarch64-dvd.iso.sha256sum”下载到本地。

    -   若为x86\_64架构。
        1.  单击“x86\_64”。
		2.  若选择本地安装，分别将发布包 “openEuler-20.03-LTS-SP2-x86\_64-dvd.iso”和校验文件“openEuler-20.03-LTS-SP2-x86\_64-dvd.iso.sha256sum”下载到本地。
        3.  若选择网络安装，分别将发布包 “openEuler-20.03-LTS-SP2-netinst-x86\_64-dvd.iso ”和校验文件“openEuler-20.03-LTS-SP2-netinst-x86\_64-dvd.iso.sha256sum”下载到本地。
...
iso文件：openEuler-20.03-LTS-SP2-aarch64-dvd.iso

校验文件：openEuler-20.03-LTS-SP2-aarch64-dvd.iso.sha256sum
