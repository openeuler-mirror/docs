...
1.在配置文件中对相应参数进行配置，系统的默认配置文件存放在 /etc/aops/diag_scheduler.ini 以及 /etc/aops/diag_executor中，请根据实际情况进行配置更改。
...
- 查看，导出和删除故障树
  ...
  * web:
   ...
   在“新增故障树”区域右侧的某一故障树的右下角，点击操作按钮，可以对该树进行导出和删除等操作；
...
- 执行诊断
   ...
   * web:
   <img src="./pic/执行故障诊断.png" alt="arch" style="zoom:42%;" />
...
- 查看和删除诊断报告
	* web:
	  ...
	  <div align=left><img src="./pic/诊断报告列表.png" alt="arch" style="zoom:50%;"/>
