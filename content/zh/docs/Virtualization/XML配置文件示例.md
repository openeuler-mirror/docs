...
本节给出两个基本的AArch64虚拟机和一个x86\_64虚拟机的XML配置文件示例，供用户参考。
...
一个包含基本元素及总线元素AArch64架构虚拟机的XML配置文件，其配置示例如下：
...
## 示例三<a name="section20887925203515"></a>
...
<domain type='kvm'>
	...
	<nvram>/usr/share/edk2/ovmf/OVMF_CODE.fd</nvram>
    </os>
    <features>
	<acpi/>
    </features>
