...
lcrc start命令用于启动一个或多个容器。

## 用法<a name="zh-cn_topic_0182207106_section188811239165314"></a>

```
lcrc start [OPTIONS] CONTAINER [CONTAINER...]
```
...
<td class="cellrowborder" valign="top" width="43.09090909090909%"><p id="zh-cn_topic_0182207106_p577673362410"><a name="zh-cn_topic_0182207106_p577673362410"></a><a name="zh-cn_topic_0182207106_p577673362410"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
...
```
$ lcrc start fd7376591a9c3d8ee9a14f5d2c2e5255b02cc44cddaabca82170efd4497510e1
```
