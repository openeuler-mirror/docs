...
lcrc top用于查看容器中的进程信息。

## 用法<a name="zh-cn_topic_0183292674_section188811239165314"></a>

```
lcrc top [OPTIONS] container [ps options]
```
...
<td class="cellrowborder" valign="top" width="43.09090909090909%"><p id="zh-cn_topic_0183292674_p599115517207"><a name="zh-cn_topic_0183292674_p599115517207"></a><a name="zh-cn_topic_0183292674_p599115517207"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
...
```
$ lcrc top 21fac8bb9ea8e0be4313c8acea765c8b4798b7d06e043bbab99fc20efa72629c
