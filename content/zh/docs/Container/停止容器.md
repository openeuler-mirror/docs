...
lcrc stop命令用于停止一个或多个运行中的容器。首先向容器中的首进程会发送**SIGTERM**信号，在指定时间（默认为10s）内容器未停止时，会发送**SIGKILL**。

## 用法<a name="zh-cn_topic_0183292664_section188811239165314"></a>

```
lcrc stop [OPTIONS] CONTAINER [CONTAINER...]
```
...
<td class="cellrowborder" valign="top"><p id="zh-cn_topic_0183292664_p16284174363216"><a name="zh-cn_topic_0183292664_p16284174363216"></a><a name="zh-cn_topic_0183292664_p16284174363216"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
...
```
$ lcrc stop fd7376591a9c3d8ee9a14f5d2c2e5255b02cc44cddaabca82170efd4497510e1
