...
<td class="cellrowborder" valign="top" width="43.09090909090909%"><p id="zh-cn_topic_0183385749_p284113015293"><a name="zh-cn_topic_0183385749_p284113015293"></a><a name="zh-cn_topic_0183385749_p284113015293"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
...
-   容器串口logs日志记录功能，默认为关闭状态，需要开启可以通过"lcrc create/run --log-opt disable-log=false"开启。
