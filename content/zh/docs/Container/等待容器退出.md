...
lcrc wait用于等待一个或者多个容器退出。

## 用法<a name="zh-cn_topic_0183292673_section188811239165314"></a>

```
lcrc wait [OPTIONS] CONTAINER [CONTAINER...]
```
...
<td class="cellrowborder" valign="top" width="43.09090909090909%"><p id="zh-cn_topic_0183292673_p249913515339"><a name="zh-cn_topic_0183292673_p249913515339"></a><a name="zh-cn_topic_0183292673_p249913515339"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
