...
lcrc attach命令用于将当前终端的标准输入、标准输出和标准错误连接到正在运行的容器。

## 用法<a name="zh-cn_topic_0183292667_section188811239165314"></a>

```
lcrc attach [OPTIONS] CONTAINER
```
...
<td class="cellrowborder" valign="top" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0183292667_p11229125362213"><a name="zh-cn_topic_0183292667_p11229125362213"></a><a name="zh-cn_topic_0183292667_p11229125362213"></a>指定要连接的LCRD socket文件路径</p>
</td>
</tr>
...
```
$ lcrc attach fd7376591a9c3d8ee9a14f5d2c2e5255b02cc44cddaabca82170efd4497510e1
/ #
/ #
```
