...
1.  下载镜像
    ...
    为了快速下载，建议选择压缩版本。点击[下载](https://isrc.iscas.ac.cn/eulixos/repo/others/openeuler-raspberrypi/images/openEuler-20.03-LTS-aarch64-raspi.img.xz)，将 openEuler 树莓派版本镜像的压缩包下载到本地。

2.  下载校验文件
    
    点击[下载](https://isrc.iscas.ac.cn/eulixos/repo/others/openeuler-raspberrypi/images/openEuler-20.03-LTS-aarch64-raspi.img.xz.sha256sum)，将该压缩包的校验文件下载到本地
