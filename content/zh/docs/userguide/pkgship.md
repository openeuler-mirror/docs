...
3. 补丁查询：方便社区人员了解openEuler软件包的补丁情况以及提取补丁内容，详细内容请参见[patch-tracking](https://gitee.com/lss410313/docs/blob/master/content/zh/docs/userguide/%E8%A1%A5%E4%B8%81%E5%B7%A5%E5%85%B7.md)。
...
8. 包信息记录修改。
    配置参数[-m]，表示变更数据库中(dbName)源码包(sourceName)的maintainer为Newmaintainer；配置参数[-l]时，表示变更数据库中(dbName)源码包(sourceName)的maintainlevel为Newmaintainlevel，值在1～4之间。
