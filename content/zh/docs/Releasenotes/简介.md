...
openEuler 1.0 版本是 openEuler 开源项目对外发布的第一个版本，是一款安全稳定的高性能 Linux 服务器操作系统。openEuler 1.0 基于 Linux 主线内核 4.19 版本，进行了 bug 修改、漏洞修复等工作，并加入一些具备创新性的功能特性。openEuler 采用 OBS（Open Build Service）系统进行版本的构建和发布。用户可以从社区获取源码，并基于社区功能，进行开发、构建、编译、测试等工作。

## 最小硬件要求<a name="section1542202114014"></a>

安装openEuler 1.0所需的最小硬件要求如[表1](#tff48b99c9bf24b84bb602c53229e2541)所示。
...
<td class="cellrowborder" valign="top" width="48.74487448744874%" headers="mcps1.2.4.1.3 "><p id="aa0dbd77b34bc472cbad6f8ead108471d"><a name="aa0dbd77b34bc472cbad6f8ead108471d"></a><a name="aa0dbd77b34bc472cbad6f8ead108471d"></a>当前仅支持ARM的64位架构。后续会随版本演进，增加其他架构支持。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40.06400640064006%" headers="mcps1.2.4.1.2 "><p id="acc3e62daa72a45659482e0da1f9d47b5"><a name="acc3e62daa72a45659482e0da1f9d47b5"></a><a name="acc3e62daa72a45659482e0da1f9d47b5"></a>鲲鹏处理器</p>
</td>
<td class="cellrowborder" valign="top" width="48.74487448744874%" headers="mcps1.2.4.1.3 "><p id="a2601e9eece5f4c7bb02881c9ac647a61"><a name="a2601e9eece5f4c7bb02881c9ac647a61"></a><a name="a2601e9eece5f4c7bb02881c9ac647a61"></a>同一集群计算节点物理服务器CPU强烈建议同一系列。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40.06400640064006%" headers="mcps1.2.4.1.2 "><p id="afa753ec9e2454348a40acc4ce5067f7a"><a name="afa753ec9e2454348a40acc4ce5067f7a"></a><a name="afa753ec9e2454348a40acc4ce5067f7a"></a>至少需要一块大于120GB的硬盘</p>
</td>
