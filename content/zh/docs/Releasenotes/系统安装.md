...
<tr>
	...
	<td>openEuler扩展软件包的repo源，主要来源于第三方和社区贡献，由提供方负责维护。目录下区分AArch64架构和x86架构。</td>
</tr>
<tr>
	<td><a href="http://repo.openeuler.org/openEuler-20.03-LTS/OS/">OS</a></td>
	<td>openEuler基础安装软件包的repo源，提供在线下载和升级功能，软件包内容和ISO发布包中的基础安装软件包ISO相同。目录下区分AArch64架构和x86架构。</td>
</tr>
<tr>
...
<tr>
	...
	<td>openEuler全量软件包的repo源，提供在线下载和升级功能，软件包内容和ISO发布包中的全量软件包ISO相同。目录下区分AArch64架构和x86架构。</td>
</tr>
<tr>
...
<tr>
	...
	<td>openEuler升级软件包的repo源，用于已发布版本的bug、CVE的修复和部分软件因特性增强后的更新发布。提供在线下载和升级功能。目录下区分AArch64架构和x86架构。</td>
</tr>
</table>
