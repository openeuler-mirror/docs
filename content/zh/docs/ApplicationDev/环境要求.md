...
-   若使用的是虚拟机，则开发环境所需的小虚拟化空间要求如[表2](#table780410493819)所示。
    ...
    **表 2**  最小虚拟化空间要求
    ...
    <td class="cellrowborder" valign="top" width="39.74397439743974%" headers="mcps1.2.4.1.2 "><p id="p28051499810"><a name="p28051499810"></a><a name="p28051499810"></a>不小于1032GB（为了获得更好的应用体验，建议不小于120GB）</p>
    </td>
...
openEuler操作系统具体安装方法请参考《openEuler 1.0 安装指南》，其中“软件选择”页面的“已选环境的附加选项”中将“开发工具”勾选。
