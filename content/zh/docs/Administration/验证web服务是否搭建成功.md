...
1.  查看服务器的IP地址，命令如下：
    ...
    回显信息如下，说明服务器IP为 192.168.228.60。

    ```
    enp3s0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
    inet 192.168.228.60  netmask 255.255.0.0  broadcast 192.168.255.255
...
2.  验证web服务器是否搭建成功，用户可选择Linux或Windows系统进行验证。
    ...
    -   使用Windows系统验证
        ...
        http://_192.168.228.60_

        如果修改了端口号，输入地址格式如下：

        http://_192.168.228.60:端口号_
