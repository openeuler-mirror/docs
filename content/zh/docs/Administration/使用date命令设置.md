...
-   显示当前的日期和本地时间。
    ...
    ```
    $ date 
    2019年 08月 17日 星期一 17:26:34 CST
    ```
...
-   显示当前的日期和UTC时间。
    ...
    ```
    $ date --utc
    2019年 08月 17日 星期一 09:26:18 UTC
    ```
...
要修改当前的时间，添加--set或者-s参数。在root权限下执行如下命令，其中_ HH_  代表小时，_MM_  代表分钟，_SS_  代表秒，请根据实际情况修改：
...
修改当前的日期，添加--set或者-s参数。在root权限下执行如下命令，其中_ YYYY _代表年份_，MM _代表月份，_DD_  代表某天，请根据实际情况修改：
