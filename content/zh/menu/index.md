...
- [发行说明]({{< relref "/docs/Releasenotes/release_notes.md" >}})
  ...
  - [技术特性]({{< relref "/docs/Releasenotes/技术特性.md" >}})
    ...
    - [桌面]({{< relref "/docs/Releasenotes/桌面.md" >}})
  ...
  - [获取源代码和安装包]({{< relref "/docs/Releasenotes/获取源代码和安装包.md" >}})
 
- [安装指南]({{< relref "/docs/Installation/home.md" >}})
  ...
  - [使用kickstart自动化安装]({{< relref "/docs/Installation/使用kickstart自动化安装.md" >}})
    - [简介]({{< relref "/docs/Installation/简介.md" >}})
    - [执行kickstart安装]({{< relref "/docs/Installation/执行kickstart安装.md" >}})
      - [openEuler系统的半自动化安装]({{< relref "/docs/Installation/openEuler系统的半自动化安装.md" >}})
        - [openEuler系统的半自动化安装优缺点]({{< relref "/docs/Installation/openEuler系统的半自动化安装优缺点.md" >}})
        - [openEuler系统的半自动化安装环境需求]({{< relref "/docs/Installation/openEuler系统的半自动化安装环境需求.md" >}})
        - [openEuler系统的半自动化安装步]({{< relref "/docs/Installation/openEuler系统的半自动化安装步.md" >}})
      - [openEuler系统的全自动化安装]({{< relref "/docs/Installation/openEuler系统的全自动化安装.md" >}})
        - [openEuler系统的全自动化安装优缺点]({{< relref "/docs/Installation/openEuler系统的全自动化安装优缺点.md" >}})
        - [openEuler系统的全自动化安装环境需求]({{< relref "/docs/Installation/openEuler系统的全自动化安装环境需求.md" >}})
        - [openEuler系统的全自动化安装步骤]({{< relref "/docs/Installation/openEuler系统的全自动化安装步骤.md" >}})
    - [kickstart文件说明]({{< relref "/docs/Installation/kickstart文件说明.md" >}})
      - [kickstart文件简介]({{< relref "/docs/Installation/kickstart文件简介.md" >}})
      - [kickstart 命令]({{< relref "/docs/Installation/kickstart-命令.md" >}})
      - [选择软件包]({{< relref "/docs/Installation/选择软件包.md" >}})
      - [编写预安装脚本]({{< relref "/docs/Installation/编写预安装脚本.md" >}})
      - [编写安装后脚本]({{< relref "/docs/Installation/编写安装后脚本.md" >}})
      - [kickstart配置文件示例]({{< relref "/docs/Installation/kickstart配置文件示例.md" >}})
...
- [管理员指南]({{< relref "/docs/Administration/administration.md" >}})
  ...
  - [配置网络]({{< relref "/docs/Administration/配置网络.md" >}})
    - [配置IP]({{< relref "/docs/Administration/配置IP.md" >}})
  ...
  - [搭建服务]({{< relref "/docs/Administration/搭建服务.md" >}})
    - [搭建repo服务器]({{< relref "/docs/Administration/搭建repo服务器.md" >}})
      ...
      - [创建/更新本地repo源]({{< relref "/docs/Administration/创建-更新本地repo源.md" >}})
        ...
        - [mkrepo创建repo源]({{< relref "/docs/Administration/mkrepo创建repo源.md" >}})
      ...
      - [使用repo源]({{< relref "/docs/Administration/使用repo源.md" >}})
        ...
        - [yum相关命令]({{< relref "/docs/Administration/yum相关命令.md" >}})
...
- [容器用户指南]({{< relref "/docs/Container/container.md" >}})
  ...
  - [系统容器]({{< relref "/docs/Container/系统容器.md" >}})
    ...
    - [使用指南]({{< relref "/docs/Container/使用指南.md" >}})
      ...
      - [容器内reboot/shudown]({{< relref "/docs/Container/容器内reboot/shudown.md" >}})
  ...
  - [Docker容器]({{< relref "/docs/Container/Docker容器.md" >}})
    ...
    - [安装与升级]({{< relref "/docs/Container/安装与升级.md" >}})
      ...
      - [版本升级]({{< relref "/docs/Container/版本升级.md" >}})
        - [准备工作]({{< relref "/docs/Container/准备工作.md" >}})
        - [基线版本]({{< relref "/docs/Container/基线版本.md" >}})
        - [注意事项]({{< relref "/docs/Container/注意事项.md" >}})
        - [版本升级]({{< relref "/docs/Container/版本升级-27.md" >}})
        - [版本回滚]({{< relref "/docs/Container/版本回滚.md" >}})
      - [版本差异]({{< relref "/docs/Container/版本差异.md" >}})
...
- [虚拟化用户指南]({{< relref "/docs/Virtuanlization/virtuanlization.md" >}})
  - [前言]({{< relref "/docs/Virtuanlization/前言.md" >}})
  - [认识虚拟化]({{< relref "/docs/Virtuanlization/认识虚拟化.md" >}})
  - [安装指南]({{< relref "/docs/Virtuanlization/安装指南.md" >}})
    - [最低硬件要求]({{< relref "/docs/Virtuanlization/最低硬件要求.md" >}})
    - [安装虚拟化核心组件]({{< relref "/docs/Virtuanlization/安装虚拟化核心组件.md" >}})
      - [安装方法]({{< relref "/docs/Virtuanlization/安装方法.md" >}})
      - [验证安装是否成功]({{< relref "/docs/Virtuanlization/验证安装是否成功.md" >}})
  - [用户和管理员指南]({{< relref "/docs/Virtuanlization/用户和管理员指南.md" >}})
    - [准备环境]({{< relref "/docs/Virtuanlization/准备环境.md" >}})
      - [准备虚拟机镜像]({{< relref "/docs/Virtuanlization/准备虚拟机镜像.md" >}})
      - [准备虚拟机网络]({{< relref "/docs/Virtuanlization/准备虚拟机网络.md" >}})
      - [准备UEFI引导工具集EDK II]({{< relref "/docs/Virtuanlization/准备UEFI引导工具集EDK-II.md" >}})
    - [虚拟机配置]({{< relref "/docs/Virtuanlization/虚拟机配置.md" >}})
      - [总体介绍]({{< relref "/docs/Virtuanlization/总体介绍.md" >}})
      - [虚拟机描述]({{< relref "/docs/Virtuanlization/虚拟机描述.md" >}})
      - [虚拟CPU和虚拟内存]({{< relref "/docs/Virtuanlization/虚拟CPU和虚拟内存.md" >}})
      - [配置虚拟设备]({{< relref "/docs/Virtuanlization/配置虚拟设备.md" >}})
        - [存储设备]({{< relref "/docs/Virtuanlization/存储设备.md" >}})
        - [网络设备]({{< relref "/docs/Virtuanlization/网络设备.md" >}})
        - [总线配置]({{< relref "/docs/Virtuanlization/总线配置.md" >}})
        - [其它常用设备]({{< relref "/docs/Virtuanlization/其它常用设备.md" >}})
      - [其他常见配置项]({{< relref "/docs/Virtuanlization/其他常见配置项.md" >}})
      - [XML配置文件示例]({{< relref "/docs/Virtuanlization/XML配置文件示例.md" >}})
    - [管理虚拟机]({{< relref "/docs/Virtuanlization/管理虚拟机.md" >}})
      - [虚拟机生命周期]({{< relref "/docs/Virtuanlization/虚拟机生命周期.md" >}})
        - [总体介绍]({{< relref "/docs/Virtuanlization/总体介绍-0.md" >}})
        - [管理命令]({{< relref "/docs/Virtuanlization/管理命令.md" >}})
        - [示例]({{< relref "/docs/Virtuanlization/示例.md" >}})
      - [在线修改虚拟机配置]({{< relref "/docs/Virtuanlization/在线修改虚拟机配置.md" >}})
      - [查询虚拟机信息]({{< relref "/docs/Virtuanlization/查询虚拟机信息.md" >}})
      - [登录虚拟机]({{< relref "/docs/Virtuanlization/登录虚拟机.md" >}})
    - [热迁移虚拟机]({{< relref "/docs/Virtuanlization/热迁移虚拟机.md" >}})
      - [总体介绍]({{< relref "/docs/Virtuanlization/总体介绍-1.md" >}})
      - [应用场景]({{< relref "/docs/Virtuanlization/应用场景.md" >}})
      - [注意事项和约束限制]({{< relref "/docs/Virtuanlization/注意事项和约束限制.md" >}})
      - [热迁移操作]({{< relref "/docs/Virtuanlization/热迁移操作.md" >}})
    - [管理系统资源]({{< relref "/docs/Virtuanlization/管理系统资源.md" >}})
      - [管理虚拟CPU]({{< relref "/docs/Virtuanlization/管理虚拟CPU.md" >}})
        - [CPU份额]({{< relref "/docs/Virtuanlization/CPU份额.md" >}})
        - [绑定qemu进程至物理CPU]({{< relref "/docs/Virtuanlization/绑定qemu进程至物理CPU.md" >}})
        - [调整虚拟CPU绑定关系]({{< relref "/docs/Virtuanlization/调整虚拟CPU绑定关系.md" >}})
      - [管理虚拟内存]({{< relref "/docs/Virtuanlization/管理虚拟内存.md" >}})
        - [NUMA 简介]({{< relref "/docs/Virtuanlization/NUMA 简介.md" >}})
        - [配置Host NUMA]({{< relref "/docs/Virtuanlization/配置Host-NUMA.md" >}})
        - [配置Guest NUMA]({{< relref "/docs/Virtuanlization/配置Guest-NUMA.md" >}})
    - [管理设备]({{< relref "/docs/Virtuanlization/管理设备.md" >}})
      - [配置虚拟机PCIe控制器]({{< relref "/docs/Virtuanlization/配置虚拟机PCIe控制器.md" >}})
      - [管理虚拟磁盘]({{< relref "/docs/Virtuanlization/管理虚拟磁盘.md" >}})
      - [管理虚拟网卡]({{< relref "/docs/Virtuanlization/管理虚拟网卡.md" >}})
      - [配置虚拟串口]({{< relref "/docs/Virtuanlization/配置虚拟串口.md" >}})
    - [最佳实践]({{< relref "/docs/Virtuanlization/最佳实践.md" >}})
      - [halt-polling]({{< relref "/docs/Virtuanlization/halt-polling.md" >}})
      - [内存大页]({{< relref "/docs/Virtuanlization/内存大页.md" >}})
  - [附录]({{< relref "/docs/Virtuanlization/附录.md" >}})
    - [术语和缩略语]({{< relref "/docs/Virtuanlization/术语和缩略语.md" >}})